...
#ifndef _INNOVARPC_H_
#define _INNOVARPC_H_ 1
...
extern json_spirit::Value fetchbalance(const json_spirit::Array& params, bool fHelp); // I n n o v a - Q0FSU0VOIEtMT0NL
