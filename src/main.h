...
#define BLOCK_START_COLLATERALNODE_PAYMENTS_TESTNET 550 // Testnet Collateralnode payments enabled block 550
#define BLOCK_START_COLLATERALNODE_PAYMENTS 800 //Mainnet Collateralnode payments not enabled until block 800
#define BLOCK_START_COLLATERALNODE_DELAYPAY 2500 //Activates a delay in payment for MNs - I n n o v a Block 2500 | Not Used!
...
static const int64_t COLLATERALNODE_COLLATERAL = (25000*COIN); // 25,000 INN
static const int64_t COLLATERALNODE_FEE = (0.010000*COIN); //0.01 INN
static const int64_t POOL_FEE_AMOUNT = (0.1*COIN); //0.1 INN
static const int64_t COLLATERALNODE_POOL_MAX = (51000*COIN); //51,000 INN
...
static const int MN_ENFORCEMENT_ACTIVE_HEIGHT_TESTNET = 550; //Enforce Collateral Node payments after this height for Innova Testnet
...
static const std::string vBurnAddresses("iCdQa64v4a1V2anyg3iqsdLF6SBZ23KFzP");
