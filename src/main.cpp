...
int64_t GetProofOfWorkReward(int nHeight, int64_t nFees)
{
  ...
  if (pindexBest->nHeight == 1)
      ...
      nSubsidy = 1 * COIN;
    else if (pindexBest->nHeight <= 7750000) // 0.75 Coin PoW Reward to release 168,750 INN in 225,000 blocks
      nSubsidy = 0.75 * COIN;
    else if (pindexBest->nHeight <= 8000000) // 0.5 Coin PoW Reward to release 125,000 INN in 250,000 blocks
      nSubsidy = 0.5 * COIN;
    else if (pindexBest->nHeight <= 8250000) // 0.25 Coin PoW Reward to release 62,500 INN in 250,000 blocks
      nSubsidy = 0.25 * COIN;
    else if (pindexBest->nHeight <= 8500000) // 0.2 Coin PoW Reward to release 50,000 INN in 250,000 blocks
      nSubsidy = 0.2 * COIN;
    else if (pindexBest->nHeight <= 8750000) // 0.15 Coin PoW Reward to release 37,500 INN in 250,000 blocks
      nSubsidy = 0.15 * COIN;
    else if (pindexBest->nHeight <= 9000000) // 0.1 Coin PoW Reward to release 1 CollateralNode in 250,000 blocks
      nSubsidy = 0.1 * COIN;
    else if (pindexBest->nHeight <= 9250000) // 0.05 Coin PoW Reward to release 12,500 INN in 250,000 blocks
      nSubsidy = 0.05 * COIN;
    else if (pindexBest->nHeight <= 9500000) // 0.01 Coin PoW Reward to release 2,500 INN in 250,000 blocks
      nSubsidy = 0.01 * COIN;
    else if (pindexBest->nHeight <= 9750000) // 0.05 Coin PoW Reward to release 12,500 INN in 250,000 blocks
      nSubsidy = 0.05 * COIN;
    else if (pindexBest->nHeight <= 10000000) // 0.01 Coin PoW Reward to release 2,500 INN in 250,000 blocks
      nSubsidy = 0.01 * COIN;
