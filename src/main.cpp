...
int64_t GetProofOfWorkReward(int nHeight, int64_t nFees)
{
  ...
  if (pindexBest->nHeight == 1)
      ...
      nSubsidy = 0.5 * COIN;
    else if (pindexBest->nHeight <= 2500000) // 0.1 Coin PoW Reward for peak payout in new cycle to release 1 CollateralNode in 250,000 blocks
      nSubsidy = 0.1 * COIN;
    else if (pindexBest->nHeight <= 2750000) // 0.15 Coin PoW Reward to release 37,500 INN in 250,000 blocks
      nSubsidy = 0.15 * COIN;
