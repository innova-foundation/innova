...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Innova";
#else
    fs::path pathRet;
...
//
// Write innova.conf by CircuitBreaker88
//
...
void WriteConfigFile(FILE* configFile)
{
    ...
    fputs ("addnode=23.95.221.245\n", configFile);
    fputs ("addnode=47.198.208.28\n", configFile);
    fputs ("addnode=134.255.88.140\n", configFile);
    fputs ("addnode=80.110.125.107\n", configFile);
    fputs ("addnode=73.27.102.84\n", configFile);
    fputs ("addnode=37.252.70.76\n", configFile);
    fputs ("addnode=94.253.239.222\n", configFile);
    fputs ("addnode=218.214.99.111\n", configFile);
    fputs ("addnode=94.253.238.184\n", configFile);
    fputs ("addnode=51.195.7.48\n", configFile);
    fputs ("addnode=46.82.119.188\n", configFile);
    fputs ("addnode=75.130.239.0\n", configFile);
    fputs ("addnode=47.26.4.18\n", configFile);
    fputs ("addnode=85.214.168.52\n", configFile);
    fputs ("addnode=91.83.164.126\n", configFile);
    fputs ("addnode=194.182.69.84\n", configFile);
    fputs ("addnode=5.9.145.235\n", configFile);
    fputs ("addnode=167.86.84.242\n", configFile);
    fputs ("addnode=159.65.67.220\n", configFile);
    fputs ("addnode=95.217.98.228\n", configFile);
    fputs ("addnode=37.25.122.80\n", configFile);
    fputs ("addnode=88.198.135.174\n", configFile);
    fputs ("addnode=95.217.70.54\n", configFile);
    fputs ("addnode=194.182.70.121\n", configFile);
    fputs ("addnode=154.49.211.241\n", configFile);
    fputs ("addnode=37.201.49.7\n", configFile);
    fclose(configFile);
...
{
    boost::filesystem::path pathConfigFile(GetArg("-fsconf", "collateralnode.conf"));
    if (!pathConfigFile.is_complete()) pathConfigFile = GetDataDir(false) / pathConfigFile;
    return pathConfigFile;
}
    ...
    if (vTimeOffsets.size() >= 5 && vTimeOffsets.size() % 2 == 1)
    {
        ...
        else
        {
            ...
            if (!fDone)
            {
                ...
                {
                    fDone = true;
                    string strMessage = _("Warning: Please check that your computer's date and time are correct! If your clock is wrong Innova will not work properly.");
                    strMiscWarning = strMessage;
                    printf("*** %s\n", strMessage.c_str());
                    uiInterface.ThreadSafeMessageBox(strMessage+" ", string("Innova"), CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION);
                }
            }
        }
        if (fDebug) {
