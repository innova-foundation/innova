...
bool IsSporkActive(int nSporkID)
{
    ...
    if(mapSporksActive.count(nSporkID)){
        ...
        if(nSporkID == SPORK_1_COLLATERALSTAKE_PAYMENTS_ENFORCEMENT) r = SPORK_1_COLLATERALSTAKE_PAYMENTS_ENFORCEMENT_DEFAULT;
...
{
    if(strName == "SPORK_1_COLLATERALSTAKE_PAYMENTS_ENFORCEMENT") return SPORK_1_COLLATERALSTAKE_PAYMENTS_ENFORCEMENT;
...
{
    if(id == SPORK_1_COLLATERALSTAKE_PAYMENTS_ENFORCEMENT) return "SPORK_1_COLLATERALSTAKE_PAYMENTS_ENFORCEMENT";
