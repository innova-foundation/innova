...
struct NameTableEntryAll
{
    ...
    NameTableEntryAll() : nExpiresAt(NAME_NON_EXISTING) {}
    NameTableEntryAll(const QString &name, const QString &value, int nExpiresAt) :
        name(name), value(value), nExpiresAt(nExpiresAt) {}
    NameTableEntryAll(const std::string &name, const std::string &value, int nExpiresAt) :
        name(QString::fromStdString(name)), value(QString::fromStdString(value)), nExpiresAt(nExpiresAt) {}
};
